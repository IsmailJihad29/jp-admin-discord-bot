...
| **`!features`** | `!feature`, `!toggle` | Mentor / Supervisor | `#jp-admin` | `!features`<br>`!feature on <name>`<br>`!feature off <name>`<br>`!feature toggle <name>`<br>`!feature reset` | সার্ভারের প্রতিটি ফিচার ও অটোমেশন (যেমন: মর্নিং অ্যাটেন্ডেন্স, ডেইলি অ্যাটেন্ডেন্স, জব স্ক্র্যাপার, এআই ইত্যাদি) আলাদা আলাদাভাবে অন বা অফ রাখার ইন্টারেক্টিভ ড্যাশবোর্ড ও ওয়ান-ক্লিক কন্ট্রোল বাটন। |
...
| কমান্ডের নাম (Command) | বিকল্প নাম (Aliases) | অনুমতি (Role) | অনুমোদিত চ্যানেল (Channel) | সিনট্যাক্স ও উদাহরণ (Syntax & Example) | কাজের বিস্তারিত বিবরণ (Description) |
| :--- | :--- | :--- | :--- | :--- | :--- |
| **`!morningattendance`** | `!morningatt`, `!morning` | Mentor / Supervisor | `#jp-admin` | `!morningattendance [YYYY-MM-DD]`<br>`!morning off [today / date]`<br>`!morning on [date]`<br>`!morning status` | গুগল ফর্মের **`Morning Attendance`** ট্যাব স্ক্যান করে উপস্থিত (+১), অনুপস্থিত (-১), ছুটি (০) হিসাব করে রিপোর্ট `#daily-attendance`-এ প্রকাশ করে। `!morning off` দিলে আজকের মর্নিং বেসক্যাম্প বন্ধ রাখে। |
| **`!morningoff`** | `!morningbasecamp`, `!offmorning`, `!basecampoff` | Mentor / Supervisor | `#jp-admin` | `!morningoff [today / YYYY-MM-DD] [কারণ]`<br>*Ex:* `!morningoff today Mentorship Off`<br>`!morningoff on [date]` | আজকের মর্নিং বেসক্যাম্প বন্ধ ঘোষণা করে, সবার জন্য **০ পয়েন্ট** নির্ধারণ করে (কাউকে অনুপস্থিত জরিমানা করে না), ১২:০০ টার অটো-স্ক্যান বন্ধ রাখে এবং স্টুডেন্ট চ্যানেলে নোটিশ দেয়। |
| **`!morning optional`** | `!morningopt`, `!morningexempt` | Mentor / Supervisor | `#jp-admin` | `!morning optional add @student1 @student2 [কারণ]`<br>`!morning optional remove @student`<br>`!morning optional list`<br>`!morning optional role @Role`<br>`!morning optional clear` | নির্দিষ্ট শিক্ষার্থী বা রোলের জন্য মর্নিং বেসক্যাম্প অপশনাল নির্ধারণ করে। তারা সকালে ক্লাসে না আসলে কোনো অনুপস্থিতি জরিমানা (-১ পয়েন্ট) পাবে না, তাদের রেকর্ড `OPT` (০ পয়েন্ট) হিসেবে গণ্য হবে। |
| **`!checkattendance`** | `!attendance`, `!att` | Mentor / Supervisor | `#jp-admin` | `!checkattendance [YYYY-MM-DD]`<br>`!checkattendance all`<br>`!attendance sync` | গুগল ফর্মের **`Daily Attendance`** ট্যাব স্ক্যান করে স্কোর আপডেট করে এবং রিপোর্ট `#daily-attendance` চ্যানেলে প্রকাশ করে। `!checkattendance all` দিলে সব পুরোনো তারিখ সিঙ্ক করে। |
| **`!syncattendance`** | `!backfillattendance`, `!attbackfill`, `!attendancesync` | Mentor / Supervisor | `#jp-admin` | `!syncattendance [all / daily / morning]`<br>`!syncattendance YYYY-MM-DD to YYYY-MM-DD`<br>*Ex:* `!syncattendance all` | **Daily Attendance** এবং **Morning Attendance** উভয় গুগল ফর্মের সকল অতীত ও পূর্ববর্তী তারিখের ডেটা একবারে বাল্ক সিঙ্ক করে, শিটের ম্যাট্রিক্সে সেভ করে এবং প্রতিটি শিক্ষার্থীর পয়েন্ট স্বয়ংক্রিয়ভাবে হিসাব করে স্কোরকার্ড ও লিডারবোর্ডে যুক্ত করে। |
...
| **`!leaves`** | `!allleaves`, `!leaves pending`, `!repairleaves`, `!leavesync` | Mentor / Supervisor | `#jp-admin` | `!leaves [pending / approved / rejected / all]`<br>`!leaves sync` (বা `!repairleaves`)<br>*Ex:* `!leaves sync` | শিক্ষার্থীদের জমা দেওয়া সকল ছুটির আবেদন **[Approve]** ও **[Reject]** বাটন সহ প্রদর্শন করে। `!leaves sync` বা `!repairleaves` দিলে পূর্বের সব পুরনো লিভ ডেটা নতুন ১১-কলাম ফরম্যাটে মাইগ্রেট করে এবং `All Data` ও `Bot_Map` থেকে নাম, ইমেইল ও মোবাইল নম্বর ব্যাকফিল/সিঙ্ক করে। |
...
| কমান্ডের নাম (Command) | বিকল্প নাম (Aliases) | অনুমতি (Role) | অনুমোদিত চ্যানেল (Channel) | সিনট্যাক্স ও উদাহরণ (Syntax & Example) | কাজের বিস্তারিত বিবরণ (Description) |
| :--- | :--- | :--- | :--- | :--- | :--- |
| **`!points`** | `!pointsystem`, `!scoring`, `!scoresystem`, `!pointrules`, `!pointguide` | Everyone (Student / Mentor) | Any Channel / `#jp-admin` | `!points`<br>`!points [attendance / jobs / streaks / interviews / tasks]`<br>`!points post [#channel]` | কোহোর্টের সম্পূর্ণ অফিশিয়াল পয়েন্ট সিস্টেম (উপস্থিতি, জব টায়ার, স্ট্রিক বোনাস, ইন্টারভিউ রিওয়ার্ড, জব টাস্ক ও আরটিবিআর স্কোর) বিস্তারিত ব্যাখ্যা করে। মেন্টররা `!points post` দিয়ে পুরো নির্দেশিকা যেকোনো চ্যানেলে ব্রডকাস্ট করতে পারেন। |
| **`!myhealth`** | `!myprofile`, `!mystatus`, `!healthcheck`, `!me` | Student / Staff | **`#dev-health-check`** | `!myhealth`<br>`!myhealth refresh` | শিক্ষার্থীর সাপ্তাহিক ও লাইফটাইম স্কোরকার্ড, র‍্যাঙ্ক, অ্যাটেন্ডেন্স, জবস, সাম্প্রতিক পয়েন্ট ট্রানজেকশন (অডিট লেজার) এবং অ্যাক্টিভ/ইনঅ্যাক্টিভ স্ট্যাটাস ইনস্ট্যান্ট গুগল শিট ক্যাশ থেকে প্রদর্শন করে। `!myhealth refresh` দিয়ে লাইভ রিক্যালকুলেট ও শিটে সিঙ্ক করা যায়। |
| **`!syncscores`** | `!storescores`, `!calculatescores`, `!syncpoints` | Mentor / Supervisor | `#jp-admin` | `!syncscores` | সকল শিক্ষার্থীর সাপ্তাহিক ও লাইফটাইম পয়েন্ট, র‍্যাঙ্ক এবং অ্যাক্টিভ/ইনঅ্যাক্টিভ স্ট্যাটাস ক্যালকুলেট করে গুগল শিটের `Scores` ট্যাবে প্রি-স্টোর করে যাতে রিয়েল-টাইমে ভারী ক্যালকুলেশন ছাড়াই ইনস্ট্যান্ট রেজাল্ট পাওয়া যায়। |
...
| **`!leaderboard`** | `!rtbr`, `!weeklyreport`, `!topstudents`, `!publishleaderboard`, `!ranks` | Student / Staff / Mentor | **`#referral-leaderboard`** / `#jp-admin` | `!leaderboard`<br>`!leaderboard post [#channel]`<br>`!publishleaderboard` | টপ ১০ সহ **সকল শিক্ষার্থীর রিয়েল-টাইম পারফরম্যান্স ও RTBR লিডারবোর্ড** গণনা করে প্রকাশ করে। প্রতি বৃহস্পতিবার রাত ১১:৩০ টায় (23:30) এটি স্বয়ংক্রিয়ভাবে পাবলিশ হয়, এছাড়াও মেন্টররা যেকোনো সময় `!leaderboard post` দিয়ে ইনস্ট্যান্ট লাইভ স্কোর পাবলিশ করতে পারেন। |
