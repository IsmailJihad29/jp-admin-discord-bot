...
function buildFullGuideEmbed(guildId) {
  ...
  return Embeds.info(
    ...
    `• ⚪ **মর্নিং বেসক্যাম্প অফ (Morning Off):** \`০ পয়েন্ট\` *(সবার জন্য মাফ)*\n` +
    `*💡 নিয়ম: Daily Attendance Form (রবি-বৃহস্পতি, রাত ১১:৫৯ এর মধ্যে) এবং Morning Basecamp Form (সকাল ১১:৩০ এর মধ্যে) জমা দিতে হবে।*\n\n` +

    `━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━\n` +
    `### 💼 ২. দৈনিক চাকরির আবেদন ও টায়ার্ড স্কোরিং (Job Application Tiers)\n` +
    `প্রতিদিনের স্ট্যান্ডার্ড টার্গেট: **\`${target}টি আবেদন\`** *(Google Sheet থেকে রাত ১১:৩০ টায় অটো-স্ক্যান হয়)*\n` +
    `• 🌟 **> ১০০% টার্গেট (${target + 1}+ টি আবেদন):** \`+${tiers.FULL + tiers.EXTRA_BONUS}.0 পয়েন্ট\` *(+${tiers.FULL} ফুল + ${tiers.EXTRA_BONUS} এক্সট্রা বোনাস!)*\n` +
    `• 🟢 **১০০% টার্গেট (${target}টি আবেদন):** \`+${tiers.FULL}.0 পয়েন্ট\`\n` +
    `• 🟡 **৮০% থেকে ৯৯% (${Math.ceil(target * 0.8)}-${target - 1}টি আবেদন):** \`+${tiers.TIER_80} পয়েন্ট\`\n` +
    `• 🟠 **৭০% থেকে ৭৯% (${Math.ceil(target * 0.7)}টি আবেদন):** \`+${tiers.TIER_70} পয়েন্ট\`\n` +
    `• 🔵 **৬০% থেকে ৬৯% (${Math.ceil(target * 0.6)}টি আবেদন):** \`+${tiers.TIER_60} পয়েন্ট\`\n` +
    `• 🔴 **< ৬০% (${Math.ceil(target * 0.6) - 1} বা তার কম আবেদন):** \`${tiers.BELOW_60} পয়েন্ট\` *(পেনাল্টি)*\n\n` +

    `━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━\n` +
    `### 🔥 ৩. ধারাবাহিক স্ট্রিক বোনাস (Consistency Streaks)\n` +
    `• টানা প্রতিদিন **১০০% টার্গেট (${target}+ আবেদন)** পূরণ করলে: প্রতি দিনের জন্য **\`+${scoring.streakBonusPerDay}.0 বোনাস পয়েন্ট\`**\n` +
    `• সর্বোচ্চ স্ট্রিক ক্যাপ: **\`+${scoring.streakCap}.0 পয়েন্ট পর্যন্ত\`**\n` +
    `*💡 কোনো একদিন টার্গেট মিস হলে স্ট্রিক রিসেট হয়ে যাবে! ধারাবাহিকতাই সফলতার মূল চাবিকাঠি।*\n\n` +

    `━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━\n` +
    `### 🎙️ ৪. ইন্টারভিউ লগ ও প্রস্তুতি (Interview Prep)\n` +
    `• যেকোনো রিয়েল ইন্টারভিউ বা মক ইন্টারভিউ দিয়ে \`!interview\` দিয়ে লগ করলে: **\`+${scoring.interviewPoints}.0 পয়েন্ট প্রতি ইন্টারভিউ\`**\n\n` +

    `━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━\n` +
    `### 🛠️ ৫. জব টাস্ক ও কোম্পানি অ্যাসাইনমেন্ট (Job Tasks)\n` +
    `• কোনো কোম্পানি থেকে টেকনিক্যাল টাস্ক পেয়ে \`!task\` দিয়ে লগ করলে: **\`+1.0 পয়েন্ট\`**\n` +
    `• সমাধান তৈরি করে মেন্টর দ্বারা সলিউশন অ্যাপ্রুভ করালে (\`!task submit\`): **\`+1.0 অতিরিক্ত পয়েন্ট\`**\n` +
    `• ডেডলাইন মিস করলে বা সাবমিট না করলে: **\`-2.0 পয়েন্ট জরিমানা\`**\n\n` +

    `━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━\n` +
    `### 🏆 ৬. সর্বমোট পয়েন্ট ও রেফারেল অগ্রাধিকার (RTBR Score)\n` +
    `আপনার মোট স্কোর হিসাব হয়:\n` +
    `\`Total Score = Attendance + Job Points + Streak Bonus + Interviews + Task Points\`\n\n` +
